            ...
            <div className="bg-black text-white py-20 h-screen">
                <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
                    <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
                        {/* <div>
                            <img alt="" 
                                className="inline-block hidden lg:block max-w-[150px] max-h-[250px]" 
                                src={image2} 
                            />
                        </div> */}
                        <h1 className="text-3xl md:text-5xl p-2 text-yellow-300 tracking-loose">{DATA.title}</h1>
                        <h2 className="text-3xl md:text-5xl leading-relaxed md:leading-snug mb-2">{DATA.name}
                        </h2>
                        <p className="text-sm md:text-base text-gray-50 mb-4">
                            {DATA.info}
                        </p>
                        <a href={DATA.link}
                            className="bg-transparent hover:bg-yellow-300 text-yellow-300 hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border border-yellow-300 hover:border-transparent hover:cursor-pointer">
                            Explore Now</a>
                    </div>
